object Dependencies {
    ...
    object WorkManager {
        const val work_manager = "androidx.work:work-runtime-ktx:${Version.work_manager_version}"
    }

    object DataStore {
        const val data_store =
            "androidx.datastore:datastore-preferences:${Version.datastore_preferences_version}"
    }
    ...
    object Compose {
        ...
        const val constraintlayout_compose =
            "androidx.constraintlayout:constraintlayout-compose:${Version.constraintlayout_compose_version}"
    }
    ...
    object Room {
        ...
        const val room = "androidx.room:room-ktx:${Version.room_version}"
    }
    ...
    object Testing {
        const val kotlinx_coroutines_test =
            "org.jetbrains.kotlinx:kotlinx-coroutines-test:${Version.kotlinx_coroutines_test_version}"
        const val arch_core_testing =
            "androidx.arch.core:core-testing:${Version.arch_core_testing_version}"
